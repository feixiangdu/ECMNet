...
def parse_args():
    ...
    # model and dataset
    parser.add_argument('--model', type=str, default="ECMNet", help="model name: (default ENet)")
    parser.add_argument('--dataset', type=str, default="camvid", help="dataset: cityscapes or camvid")
    parser.add_argument('--input_size', type=str, default="1024,2048", help="input size of model")
    parser.add_argument('--num_workers', type=int, default=12, help=" the number of parallel threads")
